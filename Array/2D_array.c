...
int main()
{
    ...
    int A[3][4]={{1,2,3,4}, {2,4,6,8}, {3,5,7,9}}; //It will be created inside stack section.
    ...
    int *B[3];  //It will be created in stack
    B[0]=(int*)malloc(sizeof(int)*4);   //This array will be created in heap.
    B[1]=(int*)malloc(sizeof(int)*4);   //This array will be created in heap.
    B[2]=(int*)malloc(sizeof(int)*4);   //This array will be created in heap.
